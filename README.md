...
| TEAM | Contribution |
| --- | --- |
| Suchandranath Bajjuri |  Front end and Backend API implementation - log machine hours, Calory count calculation logic, Book class Page Implemented previous day, week, month logics for dashboards,admin dashboard to see the number of visitors, AWS deployment and Autoscaling AWS Deployment EC2 instances, loadbalancer |
...
| Madhuri Ghattamaneni | UI Implementation and backend API implementation of Members View Activity Page, getting activity hours api of past week pages along with Non members page, free trials|
